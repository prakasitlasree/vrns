<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Register.aspx.vb" Inherits="VRNS.WebUI.Register" %>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td align="right">
                                ROLE : </td>
                            <td align="left">
                                <asp:DropDownList ID="ddlROLE" runat="server" Width="300px" Enabled="False">
                                </asp:DropDownList>
                                &nbsp;ผู้ดูแลระบบจะเป็นคนจัดการสิทธิ์สำหรับใช้งาน<br />
                                <br />
                            </td>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="CheckBox1" runat="server" 
                                    Text="ส่ง e-mail เพื่อยืนยันการสมัคร" />
                                &nbsp;
                            </td>
                            <td>
                                &nbsp;
